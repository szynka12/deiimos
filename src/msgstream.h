...
public:
  // verbosity
  enum v_level {SILENT = 0, INFO1 = 1, INFO2 = 2, INFO3 = 3 };
...
public:
  msgstream()
      : standard_ostream_(std::cout.rdbuf()), null_ostream_(&null_buffer_),
...
inline void verbosity(int l) {
  INTERNAL::msg_.set_verobisity(static_cast<deiimos::msgstream::v_level>(l));
}

inline void set_warning(bool flag){
    INTERNAL::msg_.set_warning(flag);
}

inline std::ostream &msg(msgstream::v_level l = msgstream::INFO1) { return INTERNAL::msg_.msg(l); }
inline std::ostream &msg(int l) {
  return INTERNAL::msg_.msg(static_cast<deiimos::msgstream::v_level>(l));
}

inline std::ostream &err() { return INTERNAL::msg_.error(); }

inline std::ostream &warn() { return INTERNAL::msg_.warning(); }
